...
export function updateOrganizerPassword(
  ...
  axios
    .put(
      `${baseURL}/evento/register/update/update-organizer-password/${emailId}`,
      { password }
    )
    .then((res) => {
      if (callback != null) {
...
export function updateUserPassword(emailId, password, callback, errorcallback) {
  axios
    .put(`${baseURL}/evento/register/update/update-user-password/${emailId}`, {
      password,
    })
    .then((res) => {
      if (callback != null) {
...
export function updateUserProfile(emailId, payload, callback, errorcallback) {
  ...
  axios
    .put(
      `${baseURL}/evento/register/update/update-user/${emailId}/${userName}/${mobileNo}`
    )
    .then((res) => {
      if (callback != null) {
        callback(res.data);
...
export function updateProfileAPI(emailId, payload, callback, errorcallback) {
  ...
  axios
    .put(
      `${baseURL}/evento/register/update/update-organizer/${emailId}/${organizerName}/${mobileNo}`
    )
    .then((res) => {
      if (callback != null) {
        callback(res.data);
...
export function updateVenueAPI(id, emailId, payload, callback, errorcallback) {
  axios
    .put(
      `${baseURL}/evento/register/update-organizer/theatreDetails/${id}/${emailId}`,
      payload
    )
    .then((res) => {
      if (callback != null) {
